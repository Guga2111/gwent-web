...
export type Ability = 'NONE' | 'SPY' | 'TIGHT_BOND' | 'MORALE_BOOST' | 'MEDIC' | 'MUSTER' | 'SCORCH' | 'DUMMY' | 'COMMANDERS_HORN' | 'BERSERKER' | 'MARDROEME' | 'AGILE' | 'FROST' | 'FOG' | 'RAIN' | 'CLEAR_WEATHER' | 'SKELLIGE_STORM' | 'KAMBI'
